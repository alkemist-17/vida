...
func printHelp() {
	...
	fmt.Printf("\t%-11v run focused or all scripts in path or project\n", TEST)
	fmt.Printf("\t%-11v download dependencies or those listed in vida.toml\n", INSTALL)
	fmt.Printf("\t%-11v compile script to native code\n", COMPILE)
